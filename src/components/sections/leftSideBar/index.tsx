  ...
  return (
    <div className='px-4 fixed mt-5 hidden lg:block'>
        <div className="flex flex-col gap-2">
            ...
            <LeftSidebarLink image="/icons/groups.png" text="Groups" />
            <LeftSidebarLink image="/icons/market.png" text="Marketplace" />
            <LeftSidebarLink image="/icons/saved.png" text="Saved" />
            <LeftSidebarLink image="/icons/pages.png" text="Pages" />
            <LeftSidebarLink image="/icons/events.png" text="Events" />
            <LeftSidebarLink image="/icons/recents.png" text="Most Recent" />

            <div className="flex items-center gap-3 w-[200px] py-2 pl-1 cursor-pointer hover:bg-gray-300">
                <div className="bg-gray-300 w-[30px] h-[30px] grid place-items-center rounded-full">
                    <BiChevronDown />
                </div>
